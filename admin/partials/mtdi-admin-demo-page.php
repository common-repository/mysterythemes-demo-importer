									...
									<div class="mtdi-each-demo theme mtdi_gl-item js-ocdi-gl-item" data-categories="ltrdemo" data-name="<?php echo esc_attr( $theme_slug ); ?>" style="display: block;">
										...
										<div class="theme-id-container">
											...
											<div class="mtdi-theme-actions theme-actions">
												...
												?>
														<a class="button disabled button-primary hide-if-no-js" href="javascript:void(0);" data-name="<?php echo esc_attr( $theme_name ); ?>" data-slug="<?php echo esc_attr( $theme_slug ); ?>" aria-label="<?php printf( /* translators: %s: theme name */ esc_html__( 'Imported %1$s', 'mysterythemes-demo-importer' ), esc_html( $theme_name ) ); ?>">
												...
												?>
															<a class="button button-primary mtdi-purchasenow" href="<?php echo esc_url( $purchaseurl ); ?>" target="_blank" data-name="<?php echo esc_attr( $theme_name ); ?>" data-slug="<?php echo esc_attr( $theme_slug ); ?>" aria-label="<?php printf( /* translators: %s: theme name */ esc_html__( 'Purchase Now %1$s', 'mysterythemes-demo-importer' ), esc_html( $theme_name ) ); ?>">
																<?php esc_html_e( 'Purchase Now', 'mysterythemes-demo-importer' ); ?>
															</a>
												<?php
														} else {
												?>
															<a class="button button-primary hide-if-no-js mtdi-demo-import" href="javascript:void(0);" data-name="<?php echo esc_attr( $theme_name ); ?>" data-slug="<?php echo esc_attr( $theme_slug ); ?>" aria-label="<?php printf( /* translators: %s: theme name */ esc_html__( 'Import %1$s', 'mysterythemes-demo-importer' ), esc_html( $theme_name ) ); ?>">
